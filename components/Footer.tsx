      ...
      <section id="about-me" className="relative z-10 w-full bg-[#0F314D] pb-32">
        ...
        <div className="absolute bottom-10 left-0 right-0 text-center z-50">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 text-[#3FE2FF] text-[13px] md:text-[15px] font-bold tracking-wide no-underline hover:brightness-125 transition-all opacity-90"
          >
            <svg
              viewBox="0 0 24 24"
